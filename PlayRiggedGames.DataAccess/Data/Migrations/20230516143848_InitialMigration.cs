        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlackListed = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MoneyInput = table.Column<int>(type: "int", nullable: false),
                    MoneyOutput = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotGameLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SlotGameLogs_AspNetUsers_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotValues", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SlotOutcomes", x => new { x.GameId, x.Location });
                    table.ForeignKey(
                        name: "FK_SlotOutcomes_SlotGameLogs_GameId",
                        column: x => x.GameId,
                        principalTable: "SlotGameLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 3, "Lucky Slots", false, 3 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SlotGameLogs_PlayerId",
                table: "SlotGameLogs",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_SlotOutcomes_SymbolId",
                table: "SlotOutcomes",
                column: "SymbolId");
