...
{
    public class LuckItems : SlotMachineDecorator
    {
        public LuckItems(SlotMachine slotMachine)
        {
        ...
        {
            SlotRowWin? slotRowWin = CheckSpecialWin(row, new List<string> { "coin", "crown", "emerald" }, "Riches!", 1000, false);
